                            ...
                            <div className=" p-6">
                                ...
                                <div className="flex items-center flex-wrap ">
                                    <Link href={'https://kapacitor.me/'} className=''>
                                        <button className='text-amber-400 inline-flex items-center md:mb-2 lg:mb-0'>Visit
                            ...
                            <div className="p-6">
                                ...
                                <div className="flex items-center flex-wrap ">
                                    <Link href={'https://play.google.com/store/apps/details?id=com.kapacitor.app'} className=''>
                                        <button className='text-amber-400 inline-flex items-center md:mb-2 lg:mb-0'>Google Play
                                            <svg className="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                <path d="M5 12h14"></path>
                                                <path d="M12 5l7 7-7 7"></path>
                                            </svg>
