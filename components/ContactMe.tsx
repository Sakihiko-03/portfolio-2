        ...
        <div className='flex flex-col space-y-8'>
          <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col space-y-2'>
            <div className='grid grid-cols-2 space-x-2'>
              <input {...register('name')} placeholder='Name' className='contactInput rounded-lg border-none' type="text" />
              <input {...register('email')} placeholder='Email' className='contactInput rounded-lg border-none' type="text" />
            </div>
            <input {...register('subject')} placeholder='Subject' className='contactInput rounded-lg border-none' type="text" />
            <textarea {...register('message')} placeholder='Message' className='contactInput rounded-lg border-none overflow-hidden' />
